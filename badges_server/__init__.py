...
def readconf():
    ...
    standard.upslimit = confdict.get("upslimit", standard.upslimit)
    standard.conttype = confdict.get("conttype", standard.conttype)
    standard.drctloca = confdict.get("drctloca", standard.drctloca)
